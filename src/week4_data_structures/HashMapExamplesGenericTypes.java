 ...
 */
public class HashMapExamplesGenericTypes {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Get a set of the keys, and loop over that set:\n");
            ...
            Collection<String> values = h.values();    //A HashMap returns all of its values in a Collection object
